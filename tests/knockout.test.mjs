...
test('output warning is capped and stable', () => { const r=assessKnockout('POSITION\u00a0IS\nCLOSED'); assert.equal(r.warning, 'role closed'); assert.equal(r.warning.length <= 80, true); });
